...
public class ThreeWheelLocalizer extends Localizer {
    ...
    public ThreeWheelLocalizer(HardwareMap map, Pose setStartPose) {
        ...
        leftEncoderPose = new Pose(-1.75 , 5.5, 0);
        rightEncoderPose = new Pose(-1.75, -5.5, 0);
        strafeEncoderPose = new Pose(-5, -1.75, Math.toRadians(90));

        hardwareMap = map;

        // TODO: replace these with your encoder ports
        leftEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "lf"));
        rightEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "armE"));
        strafeEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "lr"));
